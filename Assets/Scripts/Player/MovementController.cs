...
public class MovementController : MonoBehaviour
{
    ...
    // test for interactable object system
    private Test exposedVariables;
    ...
    private void Awake() 
    {
        ...
        // test for interactable object system
        exposedVariables = new Test(1, "hello");
    }
    ...
    // test struct for interactable object
    readonly struct Test
    {
        public Test(float one, string two)
        {
            testInt = one;
            testString = two;
        }

        public float testInt {get; }
